...
var equip = {
    ...
    hands: [
        ...
        { id: 34406, title: "Gloves of Tyri's Power", int: 32, spi: 27, sp: 47, haste: 36, sockets: ["y", "r"], bonus: { sp: 4 }, phase: 5 },
...
var quicksets = {
    t5bis: {
        ...
        gems: {
            back: [ null, null, null ],
            chest: [ 24047, 24047, 30600 ],
            feet: [ null, null, null ],
            hands: [ null, null, null ],
            head: [ 25901, 24047, null ],
            legs: [ 24047, null, null ],
            neck: [ null, null, null ],
            shoulder: [ 24047, 30600, null ],
            waist: [ 30600, 24047, null ],
